...
public interface ObjectTypeService {
     ...
     */
    AttributeTypeDTO getAttributeType(String tenantId, String id);

    /**
     * Update an existing attribute type (partial update).
     *
     * @param tenantId the tenant UUID
     * @param id       the attribute type UUID
     * @param request  update request (nullable fields for partial update)
     ...
     */
    AttributeTypeDTO updateAttributeType(String tenantId, String id, AttributeTypeUpdateRequest request);

    /**
     * Delete an attribute type.
     *
     * Verifies tenant ownership and checks that the attribute type is not
     * in use by any ObjectType before deleting.
     *
     * @param tenantId the tenant UUID
     * @param id       the attribute type UUID
     */
    void deleteAttributeType(String tenantId, String id);
}
