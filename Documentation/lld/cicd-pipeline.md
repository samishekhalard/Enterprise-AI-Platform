...
| ~~`.github/workflows/frontendold-governance.yml`~~ | ~~Legacy frontend CSS governance~~ | **[RETIRED]** |
...
| ~~Frontendold Governance~~ | ~~`.github/workflows/frontendold-governance.yml`~~ | ~~Legacy CSS audit~~ | ~~Path-filtered to `frontendold/**`~~ [RETIRED] |
