...
export class TenantThemeService {
  ...
  private _applyRootCssVars(b: Partial<TenantBranding>): void {
    ...
    if (b.secondaryColor) {
      root.style.setProperty('--tp-warning', b.secondaryColor);
    }
    if (b.surfaceColor) {
    ...
    if (b.shadowDarkColor) {
      root.style.setProperty('--nm-shadow-dark', b.shadowDarkColor);
      const darkRgb = this._hexToRgb(b.shadowDarkColor);
      root.style.setProperty('--nm-shadow-dark-rgb', `${darkRgb.r}, ${darkRgb.g}, ${darkRgb.b}`);
    }
    if (b.shadowLightColor) {
      root.style.setProperty('--nm-shadow-light', b.shadowLightColor);
      const lightRgb = this._hexToRgb(b.shadowLightColor);
    ...
    // Typography is governed globally via design-system tokens.
