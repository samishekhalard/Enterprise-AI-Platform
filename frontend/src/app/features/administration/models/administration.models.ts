...
export interface TenantSummary {
  ...
  readonly suspensionNotes?: string;
...
export function toTenantSummary(tenant: Tenant): TenantSummary {
  ...
  return {
    ...
    suspensionReason: asOptionalString(record['suspensionReason']),
    suspensionNotes: asOptionalString(record['suspensionNotes']),
    suspendedAt: asOptionalString(record['suspendedAt']),
    estimatedReactivationDate: asOptionalString(record['estimatedReactivationDate']),
  };
}
